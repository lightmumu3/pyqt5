...
class Demo(QWidget):
    def __init__(self):
        ...
        self.lcd_1.setDigitCount(10)                             #设置显示的位数
        self.lcd_1.display(1234567890)                           #显示内容

        # self.lcd_2 = QLCDNumber(self)                                   # 2
        # self.lcd_2.setSegmentStyle(QLCDNumber.Flat)             # 设置显示样式
